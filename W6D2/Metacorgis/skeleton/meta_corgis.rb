...
puts
p snack_box.get_bone_info(1) # => "Phoenician rawhide"
puts
p snack_box.get_kibble_tastiness(3) # => 45
puts

p snacks = CorgiSnacks.new(snack_box, 1)
puts
p snacks.bone # => "Bone: Phoenician rawhide: 20"
puts
p snacks.kibble # => "* Kibble: Delicately braised hamhocks: 33"
